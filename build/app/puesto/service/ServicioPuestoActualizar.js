...
class ServicioPuestoActualizar {
    static actualizarPuesto(puesto, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield dbConnection_1.default
                .task((consulta) => __awaiter(this, void 0, void 0, function* () {
                let caso = 1;
                let objGrabado;
                const verPuesto = yield consulta.oneOrNone(sql_puesto_1.SQL_PUESTO.FIND_BY_ID, [puesto.codPuesto]);
                ...
                if (verPuesto && parqueadero && tipoVehiculo) {
                    caso = 2;
                    objGrabado = yield consulta.result(sql_puesto_1.SQL_PUESTO.UPDATE, [
